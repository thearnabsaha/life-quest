...
export const themes: Theme[] = [
  ...
  // ===== Dark Mode Themes (additional) =====

  {
    id: 'midnight-amethyst',
    name: 'Midnight Amethyst',
    description: 'Deep crystalline night. Rich violet over obsidian depths.',
    emoji: '💎',
    preview: 'linear-gradient(135deg, #0c0014 0%, #1a0030 40%, #2d0052 100%)',
    colors: {
      bgBase: '#0c0014',
      bgSurface: '#100020',
      bgCard: '#1a0838',
      ...
      borderSubtle: '#3a1868',
      borderAccent: '#c084fc',
      textPrimary: 'rgba(240, 225, 255, 0.95)',
      textMuted: '#7a5aa0',
      shadow: '6px 6px 0px 0px rgba(192, 132, 252, 0.2)',
    },
  },
  {
    id: 'volcanic-forge',
    name: 'Volcanic Forge',
    description: 'Molten lava beneath dark stone. Fire-forged power.',
    emoji: '🌋',
    preview: 'linear-gradient(135deg, #0a0000 0%, #1a0800 40%, #2a1000 100%)',
    colors: {
      bgBase: '#0a0200',
      bgSurface: '#0e0400',
      bgCard: '#1c0c04',
      ...
      textMuted: '#8a6a45',
      shadow: '6px 6px 0px 0px rgba(249, 115, 22, 0.2)',
    },
  },
...

  {
    id: 'arctic-dawn',
    name: 'Arctic Dawn',
    description: 'Crisp morning light. Clean white canvas with icy blue accents.',
    emoji: '🏔️',
    preview: 'linear-gradient(135deg, #f0f6ff 0%, #dbeafe 40%, #bfdbfe 100%)',
    colors: {
      bgBase: '#f0f4f8',
      bgSurface: '#ffffff',
      bgCard: '#f8fafc',
      ...
      textMuted: '#64748b',
      shadow: '4px 4px 0px 0px rgba(37, 99, 235, 0.15)',
    },
  },
  {
    id: 'parchment-scholar',
    name: 'Parchment Scholar',
    description: 'Ancient wisdom in warm tones. Aged paper with amber ink.',
    emoji: '📜',
    preview: 'linear-gradient(135deg, #fefcf3 0%, #fef3c7 40%, #fde68a 100%)',
    colors: {
      bgBase: '#faf8f0',
      bgSurface: '#fffef5',
      bgCard: '#fefcf3',
      ...
      borderSubtle: '#e8e0c8',
      borderAccent: '#b45309',
      textPrimary: 'rgba(41, 30, 15, 0.95)',
      textMuted: '#78716c',
      shadow: '4px 4px 0px 0px rgba(180, 83, 9, 0.15)',
    },
  },
  {
    id: 'cloud-nine',
    name: 'Cloud Nine',
    description: 'Floating in soft lavender skies. Gentle purple on white cloud.',
    emoji: '☁️',
    preview: 'linear-gradient(135deg, #faf5ff 0%, #f3e8ff 40%, #e9d5ff 100%)',
    colors: {
      bgBase: '#f5f0ff',
      bgSurface: '#ffffff',
      bgCard: '#faf5ff',
      ...
      borderSubtle: '#e8daf5',
      borderAccent: '#7c3aed',
      textPrimary: 'rgba(30, 15, 55, 0.95)',
      textMuted: '#6b7280',
      shadow: '4px 4px 0px 0px rgba(124, 58, 237, 0.15)',
    },
  },
  {
    id: 'matcha-garden',
    name: 'Matcha Garden',
    description: 'Serene zen garden. Soft green tones with earthy warmth.',
    emoji: '🍵',
    ...
    colors: {
      ...
      borderSubtle: '#d1e8d5',
      borderAccent: '#16a34a',
      textPrimary: 'rgba(15, 40, 20, 0.95)',
      textMuted: '#5c7a62',
      shadow: '4px 4px 0px 0px rgba(22, 163, 74, 0.15)',
    },
  },
  {
    id: 'rose-quartz',
    name: 'Rose Quartz',
    description: 'Soft crystal warmth. Blush pink tones with rosy highlights.',
    emoji: '🌹',
    preview: 'linear-gradient(135deg, #fff1f2 0%, #ffe4e6 40%, #fecdd3 100%)',
    colors: {
      bgBase: '#fef2f2',
      bgSurface: '#ffffff',
      bgCard: '#fff5f5',
      ...
      borderSubtle: '#f0d0d5',
      borderAccent: '#e11d48',
      textPrimary: 'rgba(50, 15, 25, 0.95)',
      textMuted: '#8a6070',
      shadow: '4px 4px 0px 0px rgba(225, 29, 72, 0.15)',
    },
  },
  {
    id: 'coastal-breeze',
    name: 'Coastal Breeze',
    description: 'Ocean shore at sunrise. Sandy warmth meets sea-glass teal.',
    emoji: '🏖️',
    preview: 'linear-gradient(135deg, #f0fdfa 0%, #ccfbf1 40%, #99f6e4 100%)',
    colors: {
      bgBase: '#f0faf8',
      bgSurface: '#fefffd',
      bgCard: '#f0fdfa',
      ...
      borderSubtle: '#c8e8e0',
      borderAccent: '#0d9488',
      textPrimary: 'rgba(15, 35, 35, 0.95)',
      textMuted: '#5a7a78',
      shadow: '4px 4px 0px 0px rgba(13, 148, 136, 0.15)',
    },
  },
];
