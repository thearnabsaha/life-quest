      ...
      <AnimatePresence>
        {!isOpen && (
          <motion.button
            ...
            type="button"
            onClick={toggleOpen}
            className="fixed bottom-20 right-4 md:bottom-6 md:right-6 z-50 w-14 h-14 flex items-center justify-center border-2 border-neonGreen bg-zinc-950 text-neonGreen shadow-[4px_4px_0px_0px_#39ff14] hover:shadow-[6px_6px_0px_0px_#39ff14] transition-all hover:translate-x-[-1px] hover:translate-y-[-1px] active:translate-x-[2px] active:translate-y-[2px] active:shadow-none"
        ...
        {isOpen && (
          <motion.div
            ...
            className={clsx(
              ...
              isExpanded
                ? 'bottom-0 right-0 left-0 top-14 md:bottom-4 md:right-4 md:left-auto md:top-auto md:w-[480px] md:h-[600px]'
                : 'bottom-20 right-4 md:bottom-4 md:right-4 w-[calc(100vw-2rem)] max-w-[420px] h-[420px]'
            )}
          >
            {/* Header */}
